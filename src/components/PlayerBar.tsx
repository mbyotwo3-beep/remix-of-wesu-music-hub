...
export function PlayerBar() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 bg-card/95 backdrop-blur-xl border-t border-border z-50 shadow-[0_-4px_24px_oklch(0.48_0.22_25/8%)]">
        ...
        <div className="flex flex-col items-center gap-1 w-1/3">
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="bg-primary text-white p-2.5 rounded-full hover:scale-105 hover:brightness-110 transition-all disabled:opacity-50 shadow-md"
