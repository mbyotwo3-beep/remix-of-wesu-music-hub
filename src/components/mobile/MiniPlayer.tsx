...
export function MiniPlayer() {
  ...
  return (
    <div
      className="fixed bottom-[calc(3.5rem+env(safe-area-inset-bottom))] inset-x-0 h-16 bg-card/95 backdrop-blur-xl border-t border-border z-40 flex items-center px-4 gap-3"
    >
