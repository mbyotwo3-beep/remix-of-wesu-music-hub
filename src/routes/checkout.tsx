    ...
    <div className="min-h-screen pb-24">
      <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          {!isCard ? (
            <div className="space-y-4">
              ...
              <input
                ...
                className="w-full bg-secondary/50 border border-border rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-primary/50"
              />
        ...
        <button
          ...
          className="w-full py-4 bg-primary text-primary-foreground rounded-2xl font-bold hover:brightness-110 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
        >
