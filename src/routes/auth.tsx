    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md bg-card border border-border rounded-3xl p-8 text-center shadow-lg">
          <div className="inline-flex items-center justify-center size-14 rounded-full bg-green-500/10 mb-6">
            <Mail className="size-7 text-green-500 animate-pulse" />
          </div>
          <h1 className="text-2xl font-bold mb-3">Check your inbox</h1>
          <p className="text-muted-foreground text-sm leading-relaxed mb-6">
            We have sent a confirmation link to <strong className="text-foreground">{email}</strong>
            . Please click the link to activate your WESU+ account and start listening.
          </p>
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 bg-primary text-primary-foreground font-bold rounded-xl hover:brightness-110 transition-all text-sm cursor-pointer"
            >
              Go to Sign In
            </button>
            <Link
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <button
          ...
          disabled={loading}
          className="w-full mt-6 py-3 bg-card border border-border rounded-xl font-semibold hover:bg-foreground/5 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
        >
